class TTexts {
  static String onBoardingtitle1 = "Choose your product";
  ...
  static String onBoardingSubtitle2 =
      "For Seamless transaction,choose your Payement Path - Your convenience,Our priority !";
